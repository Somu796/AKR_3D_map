...
visualise_3D(
    plot_save_path="AKR_3D_Map/3D_Objects/cartesian_grid_with_burst_counts.json"
)
```
...
# | eval: true
visualise_3D(
    plot_save_path="AKR_3D_Map/assets/3D_Objects/LTRMlat_grid_with_burst_counts.json"
)
```
